...
void XuatMenu()
{
	...
	cout << "\n1. Nhap mang tu dong";
	cout << "\n2. Xuat mang";
	cout << "\n3. Dem so luong so le trong mang";
	cout << "\n4. Dem so luong so co 3 chu so";
	cout << "\n5. Dem cac so nam ngoai pham vi";
	cout << "\n6. Dem so luong so chinh phuong";
	cout << "\n7. Dem so lan xuat hien cua phan tu x bat dau tu vi tri cho truoc";
	cout << "\n8. Dem va xuat cac phan tu xuat hien voi it nhat k lan va k cho truoc ";
	cout << "\n=================================================\n";
}
...
void XuLyMenu(int menu, DaySo a, int& n)
{
	...
	case 3:
		cout << "\n3. Dem so luong so le trong mang";
		kq = DemSoLe(a, n);
		cout << "\n Co " << kq << " so le xuat hien trong mang";
	...
	case 7:
		...
		break;
	case 8:
		cout << "\n\Dem va xuat cac phan tu xuat hien voi it nhat k lan va k cho truoc";
